...
<!--             <input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_street_1" value="{$fields.{{$displayParams.key}}_address_street_1.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
            <input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_street_2" value="{$fields.{{$displayParams.key}}_address_street_2.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
            <input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_street_3" value="{$fields.{{$displayParams.key}}_address_street_3.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}"> -->
...
<!-- 			{$fields.{{$displayParams.key}}_address_street_1.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>
			{$fields.{{$displayParams.key}}_address_street_2.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>
			{$fields.{{$displayParams.key}}_address_street_3.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br> -->
