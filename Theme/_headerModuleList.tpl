                    ...
                    {foreach from=$groupTabs item=modules key=group name=groupList}
                        ...
                        <li class="topnav {if $smarty.foreach.groupList.last}all{/if}">
                            ...
                            <span class="notCurrentTabLeft">&nbsp;</span><span class="notCurrentTab">
                                <a href="#" id="grouptab_{$smarty.foreach.groupList.index}" class="dropdown-toggle grouptab" data-toggle="dropdown">{$group}</a>
        ...
        <!--<div class="row">-->
            <!--<div {if $smarty.cookies.sidebartoggle == 'collapsed'}style="display:none"{/if}
             ...
             class="sidebar">
                ...
                <div id="actionMenuSidebar" class="actionMenuSidebar">
                    {foreach from=$moduleTopMenu item=module key=name name=moduleList}
                        {if  $name == "OPS_appairage" || $name == "OPS_localisation" || $name == "OPS_formule" || $name == "OPS_dossier" || $name == "OPS_individu" || $name == "OPS_dispositif"  }
                                <ul>
                                    <img src="/modules/{$MODULE_TAB}/images/{$MODULE_TAB}.png" style="float: left; margin: 6px 0;" width="100%">
                                </ul>
                        {elseif $name == 'Home' && $smarty.get.module == "Home" }
                            <ul>
                                <img src="/modules/OPS_individu/images/Home.png" style="float: left; margin: 6px 0;" width="100%">
                            </ul>
                        {elseif $name == 'AOR_Reports' && $smarty.get.module == "AOR_Reports" }
                            <ul>
                                <img src="/modules/OPS_individu/images/AOR_Reports.png" style="float: left; margin: 6px 0;" width="100%">
                            </ul>
                        {elseif $name == 'Administration' && $smarty.get.module == "Administration" }
                            <ul>
                                <img src="/modules/OPS_individu/images/Admin.png" style="float: left; margin: 6px 0;" width="100%">
                            </ul>
                        {/if}
                    {/foreach}
                </div>
