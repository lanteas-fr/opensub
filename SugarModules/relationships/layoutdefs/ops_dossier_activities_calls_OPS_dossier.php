...
$layout_defs["OPS_dossier"]["subpanel_setup"]['activities'] = array (
  'order' => 10,
  'sort_order' => 'desc',
  'sort_by' => 'date_start',
  ...
  array (
    ...
    array (
      ...
      'get_subpanel_data' => 'ops_dossier_activities_meetings',
    ),
    'tasks' => 
    array (
      'module' => 'Tasks',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'ops_dossier_activities_tasks',
    ),
    'calls' => 
    array (
      'module' => 'Calls',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'ops_dossier_activities_calls',
    ),
  ),
  'get_subpanel_data' => 'activities',
);
$layout_defs["OPS_dossier"]["subpanel_setup"]['history'] = array (
  'order' => 20,
  'sort_order' => 'desc',
  ...
  array (
    ...
    array (
      'module' => 'Notes',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'ops_dossier_activities_notes',
    ),
    'emails' => 
    array (
      'module' => 'Emails',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'ops_dossier_activities_emails',
    ),
  ),
